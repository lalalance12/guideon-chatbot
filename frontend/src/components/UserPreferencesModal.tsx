...
export default function UserPreferencesModal({ isOpen, onClose }: UserPreferencesModalProps) {
  ...
  const developmentAreasOptions = [
    ...
    'Cloud Computing', 'Game Development', 'Cybersecurity'
  ];
  ...
  const handleProgrammingLanguageToggle = (language: string) => {
    ...
    const updatedLanguages = preferences.programming_languages.includes(language)
    ...
    <div className="fixed inset-0 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto shadow-xl">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-gray-800">Your Learning Preferences</h2>
          <button 
            onClick={onClose}
          ...
          <>
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-md font-semibold text-gray-700 mb-3">Preferred Course Level</h3>
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">                  {(['beginner', 'intermediate', 'advanced', 'all'] as const).map((level) => (
                    <button
                      key={level}
              ...
              <div>
                <h3 className="text-md font-semibold text-gray-700 mb-3">Programming Languages</h3>
                <div className="flex flex-wrap gap-2">                  {programmingLanguagesOptions.map((language) => (
                    <button
                      key={language}
              ...
              <div>
                <h3 className="text-md font-semibold text-gray-700 mb-3">Development Areas</h3>
                <div className="flex flex-wrap gap-2">                  {developmentAreasOptions.map((area) => (
                    <button
                      key={area}
